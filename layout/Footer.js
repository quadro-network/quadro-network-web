          ...
          <div className="row">
            ...
            <div className="col-lg-7 col-md-7">
              <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s">
                ...
                <ul>
                  <li>
                    {/* <Link legacyBehavior href="services">
                      Service
                        ...
                        <Link target="_blank" href="https://cosmos.directory/">
                      Service
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link  legacyBehavior href="https://cosmos.directory/">
                      Directory
                    </Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-3 col-md-5">
              <div className="footer-widget widget_contact_info wow fadeInUp delay-0-6s">
                <h6 className="footer-title">Email Address</h6>
                <ul>
                 
                  <li>
                    <i className="far fa-envelope" />{" "}
                    <a target="_blank" href="mailto:info@quadro.network">info@quadro.network</a>
                  </li>
                  <li>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <a target="_blank" href="https://twitter.com/quadro_network">Twitter</a>
                </li>
                <li>
                  <a target="_blank" href="https://github.com/quadro-network">GitHub</a>
                </li>
                <li>
                  <a target="_blank" href="https://discordapp.com/users/1225408886966714388">Discord</a>
                </li>
                <li>
                  <a target="_blank" href="https://t.me/quadro_network">Telegram</a>
                </li>
              </ul>
            </div>
          </div>

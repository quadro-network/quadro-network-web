...
const counterData = [
  { id: 1, text: "YEARS OF EXPERIENCE IN DEVELOPMENT", value: "7", valueType: "plus" },
  { id: 2, text: "EXPERIENCE WITH TESTNET ENVIRONMENTS", value: "40", valueType: "plus" },
  { id: 3, text: "Our Uptime", value: "99", valueType: "percent" },
];
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              <span className="h2">Hello, We are </span>
              <h1>
                <b>Blockchain</b> Validation Experts
              </h1>
              <p>
              Looking for a reliable validator?</p>
              <div className="hero-btns">
                <Link legacyBehavior href="/contact">
                  <a className="theme-btn">
                    Discover More <i className="far fa-angle-right" />
                  </a>
                </Link>
                {/* <Link legacyBehavior href="/contact">
          ...
          <div className="col-lg-5">
            <div className="author-image-part wow fadeIn delay-0-3s">
              ...
              <img src="assets/images/hero/quadro.png" alt="Author" />
